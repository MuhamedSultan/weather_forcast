...
class HoursAdapter(private val context: Context, private val state: List<State>) :
    Adapter<HoursAdapter.HoursViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HoursViewHolder {
        val view = HoursItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    override fun onBindViewHolder(holder: HoursViewHolder, position: Int) {
        ...
        holder.tempTv.text = state.main.temp.toString()
        Glide.with(context)
    ...
    class HoursViewHolder(binding: HoursItemBinding) : ViewHolder(binding.root) {
